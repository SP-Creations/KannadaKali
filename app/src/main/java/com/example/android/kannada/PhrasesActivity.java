...
public class PhrasesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        phrases.add(new Word("How are you feeling now?","Neenu ega hegiddiya?",R.raw.how_are_you));
        phrases.add(new Word("I’m feeling good.","Naanu Chennagiddene.",R.raw.i_am_feeling_good));
        phrases.add(new Word("Let’s go.","Naavu horadona.",R.raw.let_us_go));
        phrases.add(new Word("Come here.","Illi baa.",R.raw.here));
        phrases.add(new Word("See you tomorrow.","Naale sigona.",R.raw.see_you_tomorrow));
        phrases.add(new Word("Had your breakfast?","Thindi aitha?",R.raw.how_are_you));

        //Create a custom adapter to create list items for each item in the list.
        WordAdapter adapter = new WordAdapter(this,phrases,R.color.category_generic);
